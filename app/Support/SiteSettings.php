...
class SiteSettings
{
    ...
    public const DEFAULTS = [
        ...
        //
        // ตั้งต้นเป็น "ปิด" เพราะการห้ามเปิดรอบใหม่ไปหยุดฝั่งขาย ไม่ใช่ฝั่งบัญชี —
        // รอบที่ยังไม่ปิดงบยังขึ้นเป็นงานค้างบนเมนู ในคิวงาน และมีอีเมลเตือนทุกเช้า
        // อยู่ครบ เปิดสวิตช์นี้ได้ที่ /admin/settings ถ้าอยากบังคับจริงจัง
