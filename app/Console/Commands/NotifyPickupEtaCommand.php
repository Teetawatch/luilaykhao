...
class NotifyPickupEtaCommand extends Command
{
    ...
    public function handle(): int
    {
        $schedules = TripSchedule::with('trip')
            ...
            //
            // ต้องเป็นวันไทย: คำสั่งนี้วิ่งทุกนาที รวมถึงช่วงตีหนึ่งถึงเจ็ดโมงที่ UTC
            // ยังเป็นเมื่อวาน today() เฉย ๆ จะไปหารอบของ "เมื่อวาน" แล้วรอบที่รถออก
            // ตีสี่ของวันนี้จะไม่เข้าเงื่อนไขเลย — ซึ่งคือรอบที่ต้องใช้ ETA มากที่สุด
