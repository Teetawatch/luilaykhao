    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // DB-only backups: application code lives in git and uploaded
                    // media is already on R2, so we only need to protect the database.
                ],
        ...
        'destination' => [
             ...
             */
            'disks' => [
                // Private R2 bucket — DB dumps contain PII, keep them off the public disk.
                env('BACKUP_DISK', 'r2_private'),
            ],
