...
// ค่าจริงตั้งผ่าน .env ได้ เพื่อไม่ผูกข้อมูลบริษัทไว้ในโค้ด
return [
    'name' => env('COMPANY_NAME', 'ลุยลายเขา (Luilaykhao)'),
    'legal_name' => env('COMPANY_LEGAL_NAME', 'บริษัท ลุยลายเขา จำกัด'),
