...
return [
    ...
    */
    ...
    'disks' => [
        ...
        // Set R2_PUBLIC_URL to your custom domain (e.g. https://media.luilaykhao.com)
        // or the bucket's r2.dev URL. Without it, getUrl() returns the API endpoint
        // (which isn't browser-accessible).
        'r2' => [
            'driver' => 's3',
