...
## ขอบเขตปัจจุบัน (Phase 2)

หน้า LIFF รองรับ: login ผ่าน LINE, ดูรายการทริป, ดูรายละเอียด + รอบเดินทาง,
และจองแบบผู้เดินทาง 1 คน (สร้าง booking สถานะรอชำระเงิน)

ยังไม่รวม (ต่อยอดได้): เลือกที่นั่ง (seat map), จุดรับแบบปักหมุด, โปรโมชั่น/แอดออน,
ผู้เดินทางหลายคน, แสดง QR PromptPay + อัปโหลดสลิปในตัว LIFF, ผ่อนชำระ/มัดจำ
ทั้งหมดนี้มี API พร้อมอยู่แล้วใน backend — เพิ่มหน้าจอเรียกใช้ได้เลย
